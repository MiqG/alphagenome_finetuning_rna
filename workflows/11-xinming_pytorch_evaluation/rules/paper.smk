...
Duplicated verbatim in workflows/10-jax_finetuning/rules/paper.smk (same
outputs) so either workflow can produce the comparison once its own
...
workflows/06-evaluation/Snakefile vs this workflow's Snakefile).
